...
<div className="w-full h-screen flex flex-col sm:flex-row items-start sm:items-stretch">
  ...
  <div className="bg-gray-150 w-full sm:w-1/2 h-full flex flex-col p-10 justify-between items-center sm:items-start">
    <div className="w-full flex flex-col items-center sm:items-start">
      <h3 className='font-semibold text-2xl my-4'>Register</h3>
      <p className="text-base mb-2">Welcome Please enter your details.</p>
    </div>

    <div className="w-full flex flex-col">
      <form action="">
        <label htmlFor="" className='font-normal text-medium'>Name</label>
        <input type="text" placeholder='Jhon Smimmy' className='w-full text-black py-3 mb-7 border-b border-black bg-transparent outline-none focus:outline-none' />
      ...
      <div className="w-full flex flex-col items-center">
        <button className='bg-black text-white w-full py-2 mb-2 text-base font-medium hover:bg-white hover:text-black hover:border hover:border-black hover:duration-500'>Register</button>
      </div>
    </div>

    <div className="w-full flex justify-center sm:justify-start sm:block mt-3">
      <p className='text-base font-medium'>You have an account? <a href="/login" className='text-base font-semibold hover:text-blue-800 hover:underline'>Sign In</a></p>
    </div>
  </div>
</div>
</>
